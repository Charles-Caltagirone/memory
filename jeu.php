...
for ($i = 0; $i < $_SESSION['pairNmbr']*2; $i++) {
    $f = $i + 1;
    $cards[$i] = new Card($i, './img/img'.$i.'.png', './img/cs.jpg');
    $cards[$f] = new Card($f, './img/img'.$i.'.png', './img/cs.jpg');
    $i++;     
}
    ...
    <?php if ($_SESSION['end'] == 'yes'):
        ...
        session_register_shutdown(); ?>
            <div class="end-ann_container">
                <h1>! BRAVO !</h1>
                <?php if ($finalCount != 0): ?>
                <h3>Ton score est de : <?=$finalCount?></h3>
                <div class="end-ann_container__add-block">
                    <form action="" method="post">
                        <h4>Rentre ton pseudo : </h4>
                        <input type="text" name="username">
                        <input type="submit" class="restart" name="adduser" value="Enregistrer">
                    </form>
                </div>                
                <?php endif;?>                 
                <div class="end-ann_container__btn-block">
                    <form action="index.php" method="post">
                        <input type="submit" class="restart" name="reset" value="Relancer une partie">
                    </form>
                </div>
